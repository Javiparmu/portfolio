                            ...
                            <div className="bg-gray-800">
                                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                    <div className="flex justify-center divide-x divide-gray-900/5 border-x border-gray-900/5">
                                        <a href="#project-section" className={`${!projectMenuOpen ? 'pointer-events-none' : ''} flex items-center justify-center gap-x-2.5 p-3 text-md font-semibold leading-6 text-white hover:bg-gray-800 rounded-md`}>
                                            <svg className="h-5 w-5 flex-none text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <div className="mt-6 flow-root">    
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                                <div className="-mx-3">
                                    <button type="button" onClick={() => setProjectMenuOpen(!projectMenuOpen)} className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-gray-800" aria-controls="disclosure-1" aria-expanded="false">
                                        Proyectos
                                        <svg className={`h-5 w-5 flex-none transition duration-100 transform ${projectMenuOpen ? '' : 'rotate-180'}`} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                                        </svg>
                                    </button>
