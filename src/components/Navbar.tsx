            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-center p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-20">
                    <div>
                        ...
                        <div className={`absolute inset-x-0 top-0 -z-10 bg-gray-900 pt-14 shadow-lg ring-1 ring-gray-900/5 transition duration-200 transform ${productMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-100'}`}>
